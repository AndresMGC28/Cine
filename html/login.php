  ...
  <section class="formular">
    <div class="container  rounded shadow">
      ...
      <form action="login.php" method="post">
        ...
        <button type="submit" name="login" value="login" class="btn btn-success btn-block">Iniciar Sesión</button>
      </form>
      <div class="text-center mt-3">
        <p>¿No tienes cuenta? <a href="../html/registro.php" class="btn btn-link">Regístrate aquí</a></p>
      </div>
    </div>
  </section>
